...
<div class="container pb-6 pt-6">
	...
	<form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/usuarioAjax.php" method="POST" autocomplete="off" >
		...
		<p class="has-text-centered">
			SI desea Cambiar la clave de este usuario por favor llene los 2 campos. Si NO desea Cambiar la clave deje los campos vacíos.
		</p>
		<br>
		<div class="columns">
		  	<div class="column">
		...
		<br><br><br>
		<p class="has-text-centered">
			Para poder actualizar los datos por favor ingrese su USUARIO y CLAVE con la que ha iniciado sesión
		</p>
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
