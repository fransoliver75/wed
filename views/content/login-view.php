    ...
    <form class="box login" action="" method="POST" autocomplete="off" >
		...
		<p class="has-text-centered mb-4 mt-3">
			<button type="submit" class="button is-info is-rounded">Ingresar</button>
					...
					<div class="field">
                          <label><a href="app/views/content/forgotPassword.php">¿Olvidaste la contraseña?</a></label>
                    </div>
					<script src="http://localhost/pepe-ac/app/views/js/ajax.js" ></script>
					<script src="http://localhost/pepe-ac/app/views/js/main.js" ></script>
            </form>
    </div>
